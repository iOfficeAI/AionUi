...
CSBU WorkMate is a multi-process Electron app with three core layers: **renderer**, **main process**, and **preload/shared**.
...
├── base/           # UI primitives — WorkMateModal, WorkMateSelect, FlexFullContainer, etc.
