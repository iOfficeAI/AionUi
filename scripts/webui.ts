 ...
 *   AIONUI_BACKEND_BIN    : absolute path to poundingcore binary (else PATH lookup)
 *   AIONUI_BACKEND_BUNDLED_DIR : dir containing bundled-poundingcore/<plat-arch>/binary
