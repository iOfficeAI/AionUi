...
function getLogFilePath(): string {
  ...
  // Dev mode uses "CSBU-WorkMate-Dev", production uses "CSBU WorkMate"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'CSBU-WorkMate-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'CSBU WorkMate', `${today}.log`);
