...
test('keeps the active plan above the composer and restores normal scrolling after completion', async ({ page }) => {
  ...
  try {
    ...
    const entries: PlanEntry[] = [
      { content: 'Inspect the current conversation behavior', status: 'in_progress' },
      { content: 'Implement the floating plan UI', status: 'pending' },
      { content: 'Run focused and full validation', status: 'pending' },
      { content: 'Prepare the upstream draft pull request', status: 'pending' },
    ];
