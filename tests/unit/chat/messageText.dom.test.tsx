...
const mockMarkdownView = vi.fn(({ children }: { children?: React.ReactNode }) => <div data-testid='markdown-view'>{children}</div>);
...
describe('MessageText attachment paths', () => {
  ...
  it('renders assistant streaming content with the lightweight streaming markdown view', () => {
    const message: IMessageText = {
      id: 'msg-2',
      msg_id: 'msg-2',
      conversation_id: 'conv-1',
  ...
  it('keeps user messages as plain text even when a streaming flag is passed', () => {
    const message: IMessageText = {
      id: 'msg-3',
      msg_id: 'msg-3',
      conversation_id: 'conv-1',
    ...
    expect(screen.queryByTestId('streaming-markdown-view')).not.toBeInTheDocument();
