...
const COPY: Record<string, string> = {
  ...
  [`${RDC}.description`]:
    'CSBU WorkMate detected that the local database is corrupted and cannot continue startup. After confirmation, CSBU WorkMate will back up the old database and create a new local database to continue startup. Past conversations will no longer be shown, and the old database will be kept as a backup file.',
