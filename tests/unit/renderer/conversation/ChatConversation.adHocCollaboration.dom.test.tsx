...
const acpChatMock = vi.fn((_props: Record<string, unknown>) => <div data-testid='mock-acp-chat'>acp chat</div>);
...
describe('ChatConversation ad-hoc collaboration integration', () => {
  ...
  it('shows the team status seam when the team run is active', async () => {
    adHocMocks.getByConversation.invoke.mockResolvedValue({
