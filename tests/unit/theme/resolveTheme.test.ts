...
const mk = (id: string, appearance: 'light' | 'dark' = 'light'): Theme => ({ id, name: id, appearance, builtin: true, created_at: 0, updated_at: 0 });
const light = mk(LIGHT_THEME_ID);
const dark = mk(DARK_THEME_ID, 'dark');
const userTheme: Theme = { id: 'u1', name: 'Mine', appearance: 'dark', css: 'body{}', builtin: false, created_at: 1, updated_at: 1 };
