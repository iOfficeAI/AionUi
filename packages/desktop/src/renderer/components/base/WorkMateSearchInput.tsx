...
const WorkMateSearchInput = forwardRef<HTMLInputElement, WorkMateSearchInputProps>((props, ref) => {
  const {
    value,
    onChange,
    placeholder,
...
WorkMateSearchInput.displayName = 'WorkMateSearchInput';

export default WorkMateSearchInput;
