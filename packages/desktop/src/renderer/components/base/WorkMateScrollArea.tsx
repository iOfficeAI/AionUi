 ...
 * <WorkMateScrollArea className="h-400px">
 *   <div>Content...</div>
 * </WorkMateScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <WorkMateScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </WorkMateScrollArea>
 *
 * // 双向滚动 / Both directions
 * <WorkMateScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </WorkMateScrollArea>
 * ```
 */
interface WorkMateScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const WorkMateScrollArea: React.FC<WorkMateScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
WorkMateScrollArea.displayName = 'WorkMateScrollArea';

export default WorkMateScrollArea;
