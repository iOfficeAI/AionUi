        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
                  ...
                  const badgeText =
                    capability === 'supported'
                      ...
                      : capability === 'unsupported'
                        ...
                        : null;
                  return (
                    <WorkMateSelect.Option key={model} value={model}>
                      {model}
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <WorkMateSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <WorkMateSelect.Option key={option.value || 'auto'} value={option.value}>
