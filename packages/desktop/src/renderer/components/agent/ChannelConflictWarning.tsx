...
/**
 * Warning component when OpenClaw channel conflicts with CSBU WorkMate Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not CSBU WorkMate.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in CSBU WorkMate will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use CSBU WorkMate Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and CSBU WorkMate.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for CSBU WorkMate.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in CSBU WorkMate Channels and continue using OpenClaw's integration.
          </Paragraph>
