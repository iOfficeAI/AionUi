    ...
    return (
      <Tooltip {...siderTooltipProps} content={t('workbench.title')} position='right'>
        <div
          ...
          onClick={onClick}
        >
          <Home theme='outline' size='20' fill='currentColor' className='block leading-none shrink-0' style={{ lineHeight: 0 }} />
        </div>
      </Tooltip>
    );
  }
    ...
    <Tooltip {...siderTooltipProps} content={t('workbench.title')} position='right'>
      ...
      >
        <span className='size-22px flex items-center justify-center shrink-0 text-t-primary'>
          <Home theme='outline' size='16' fill='currentColor' className='block leading-none' style={{ lineHeight: 0 }} />
        </span>
