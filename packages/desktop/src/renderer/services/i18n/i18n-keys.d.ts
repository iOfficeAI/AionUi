...
export type I18nKey =
  ...
  | 'settings.agentManagement.installSuccess'
  ...
  | 'settings.agentManagement.uninstall'
  | 'settings.agentManagement.uninstallConfirm'
  | 'settings.agentManagement.uninstallSuccess'
  | 'settings.agentManagement.uninstalling'
  ...
  | 'settings.aionrs.managedCliModelsDesc'
  | 'settings.aionrs.managedCliModelsTitle'
  | 'settings.aionrs.noManagedModels'
  ...
  | 'settings.newApiManagedCliPrepCompleted'
  | 'settings.newApiManagedCliPrepCounter'
  | 'settings.newApiManagedCliPrepFailed'
  | 'settings.newApiManagedCliPrepIdle'
  | 'settings.newApiManagedCliPrepInstallingHermes'
  | 'settings.newApiManagedCliPrepInstallingOpenClaw'
  | 'settings.newApiManagedCliPrepPreparingEnvironment'
  | 'settings.newApiManagedCliPrepTitle'
