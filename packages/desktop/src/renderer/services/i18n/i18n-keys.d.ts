...
export type I18nKey =
  ...
  | 'settings.agentManagement.warmupCheckedAt'
  | 'settings.agentManagement.warmupLastError'
  | 'settings.agentManagement.warmupStatus.failed'
  | 'settings.agentManagement.warmupStatus.idle'
  | 'settings.agentManagement.warmupStatus.ready'
  | 'settings.agentManagement.warmupStatus.skipped'
  | 'settings.agentManagement.warmupStatus.unknown'
  | 'settings.agentManagement.warmupStatus.unsupported'
  | 'settings.agentManagement.warmupStatus.warming'
