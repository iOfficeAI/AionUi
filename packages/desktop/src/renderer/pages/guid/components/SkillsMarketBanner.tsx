...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/halojerry/AionUi/discussions';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/halojerry/AionUi/discussions';
