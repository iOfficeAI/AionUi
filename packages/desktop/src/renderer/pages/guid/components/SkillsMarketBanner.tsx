...
const SKILLS_MARKET_DETAILS_ZH = 'https://wcnb2ddshm1z.feishu.cn/wiki/MKMSwCUE0ii7Itkv71ScJCdOniI';
const SKILLS_MARKET_DETAILS_EN = 'https://wcnb2ddshm1z.feishu.cn/wiki/MKMSwCUE0ii7Itkv71ScJCdOniI';
