...
const RulesSection: React.FC<RulesSectionProps> = ({
  ...
  return (
    <SectionCard
      title={t('settings.knowledgeBaseRules', { defaultValue: 'Description' })}
      legend={{
        label: t('settings.knowledgeBaseAppliesAfterSave', { defaultValue: 'Applies after save' }),
        tone: 'next',
      }}
      ...
      extra={
        <div className='flex items-center gap-6px'>
          ...
          <Button
            type='text'
            size='mini'
            data-testid='btn-expand-kb-rules'
        ...
        {promptViewMode === 'edit' && isRuleEditable ? (
          <div className='h-full'>
            <Input.TextArea
              ...
              placeholder={t('settings.knowledgeBaseRulesPlaceholder', {
                defaultValue: 'Enter the knowledge base description in Markdown format...',
              })}
              autoSize={false}
