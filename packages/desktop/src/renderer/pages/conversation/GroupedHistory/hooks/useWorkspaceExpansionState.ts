...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'csbu_workmate_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'csbu-workmate:workspace-expansion-changed';
