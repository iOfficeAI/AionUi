...
const FileChangeList: React.FC<FileChangeListProps> = ({
  ...
  return (
    // min-h-0 lets this flex column shrink inside FlexFullContainer so the list
    // region becomes the sole scroll container (fixes stuck Changes tab scroll).
    <div className='flex flex-col size-full min-h-0'>
      ...
      <div className='flex-1 min-h-0 overflow-y-auto p-8px flex flex-col gap-10px'>
