 ...
 * Release builds use ~/.pounding; dev builds use ~/.pounding-dev.
 * 获取数据目录路径，macOS 上使用符号链接。
 * Release 使用 ~/.pounding，Dev 模式使用 ~/.pounding-dev。
 */
 ...
 * Release builds use ~/.pounding-config; dev builds use ~/.pounding-config-dev.
 * 获取配置目录路径，macOS 上使用符号链接。
 * Release 使用 ~/.pounding-config，Dev 模式使用 ~/.pounding-config-dev。
 */
