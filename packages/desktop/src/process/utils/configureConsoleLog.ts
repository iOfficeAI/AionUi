 ...
 *   - macOS:   ~/Library/Logs/CSBU WorkMate/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\CSBU WorkMate\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/CSBU WorkMate/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
