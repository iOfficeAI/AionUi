...
export const PROTOCOL_SCHEME = 'csbu-workmate';

/**
 * Parse a csbu-workmate:// URL into action and params.
 * Supports two formats:
 *   1. csbu-workmate://add-provider?base_url=xxx&api_key=xxx
 *   2. csbu-workmate://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
