...
/**
 * Parse an pounding:// URL into action and params.
 * Supports two formats:
 *   1. pounding://add-provider?base_url=xxx&api_key=xxx
 *   2. pounding://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
