...
/** 临时文件时间戳分隔符 */
export const AIONUI_TIMESTAMP_SEPARATOR = '_pounding_';

/** 用于匹配和清理时间戳后缀的正则表达式（兼容旧 _aionui_ 分隔符） */
export const AIONUI_TIMESTAMP_REGEX = /_(?:aionui|pounding)_\d{13}(\.\w+)?$/;
export const AIONUI_FILES_MARKER = '[[POUNDING_FILES]]';
