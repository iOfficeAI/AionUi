// Core types for @csbu-workmate/web-host (M3 interface contract, locked for M4-M8)
...
/**
 * System dirs exported to the backend via CSBU_WORKMATE_{CACHE,WORK,LOG}_DIR env.
