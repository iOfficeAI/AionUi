...
import brandLogoSrc from '@renderer/assets/logo.svg';
          ...
          >
            ...
            >
              <div
                ...
                onClick={onClick}
              >
                <img src={brandLogoSrc} alt='' className='absolute inset-0 size-full object-cover' />
              </div>
              <div className='flex-1 text-20px text-1 collapsed-hidden font-bold'>Lumen</div>
              {isMobile && !collapsed && (
                <button
                  type='button'
