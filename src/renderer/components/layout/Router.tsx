...
const DevBrowser = React.lazy(() => import('@renderer/pages/conversation/DevBrowser'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/devbrowser' element={withRouteFallback(DevBrowser)} />
          ...
          <Route path='/settings/skills' element={withRouteFallback(SkillsHubSettings)} />
          ...
          <Route path='/settings/tools' element={<Navigate to='/settings/mcp' replace />} />
