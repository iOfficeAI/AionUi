...
interface SiderSolidAiEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderSolidAiEntry: React.FC<SiderSolidAiEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('solidai:title')} position='right'>
        <div
...
export default SiderSolidAiEntry;
