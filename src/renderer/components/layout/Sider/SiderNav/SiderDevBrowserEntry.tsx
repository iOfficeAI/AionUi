...
interface SiderDevBrowserEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderDevBrowserEntry: React.FC<SiderDevBrowserEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  const label = t('conversation.devBrowser.entry');
...
export default SiderDevBrowserEntry;
