...
const SelectionToolbar: React.FC<SelectionToolbarProps> = ({ selectedText, position, onClear }) => {
  ...
  return (
    <div ref={refs.setFloating} style={{ ...floatingStyles, zIndex: 99999 }}>
      <div
        className='flex items-center px-12px py-8px bg-dialog-fill-0 rd-8px shadow-lg border border-solid border-b-base cursor-pointer hover:bg-2 transition-colors'
