...
const ConversationSearchPopover: React.FC<ConversationSearchPopoverProps> = ({
  ...
  const triggerClassName = fullWidth
    ...
    : 'h-36px w-36px p-0 bg-transparent rd-0.5rem flex items-center justify-center cursor-pointer shrink-0 transition-all border border-solid border-transparent text-t-primary';
