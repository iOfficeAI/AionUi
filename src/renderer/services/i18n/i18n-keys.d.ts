...
export type I18nKey =
  ...
  | 'conversation.subagentNavigator.description'
  | 'conversation.subagentNavigator.jumpTo'
  | 'conversation.subagentNavigator.status.active'
  | 'conversation.subagentNavigator.status.completed'
  | 'conversation.subagentNavigator.status.failed'
  | 'conversation.subagentNavigator.title'
