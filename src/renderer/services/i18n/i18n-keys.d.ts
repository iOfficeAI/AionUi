...
export type I18nKey =
  ...
  | 'conversation.model.commandDescription'
  | 'conversation.model.availableModels'
  | 'conversation.model.invalidModel'
  | 'conversation.model.notReady'
  | 'conversation.model.notSwitchable'
  | 'conversation.model.noModels'
  | 'conversation.model.switched'
  | 'conversation.model.switchFailed'
  ...
  | 'settings.serviceChecking'
  | 'settings.serviceDegraded'
  | 'settings.serviceHealth'
  | 'settings.serviceOffline'
