...
export type I18nKey =
  ...
  | 'guid.cliSessions.continueAction'
  | 'guid.cliSessions.description'
  | 'guid.cliSessions.empty'
  | 'guid.cliSessions.importFailed'
  | 'guid.cliSessions.lastActive'
  | 'guid.cliSessions.loadFailed'
  | 'guid.cliSessions.openConversation'
  | 'guid.cliSessions.quickAction'
  | 'guid.cliSessions.title'
  | 'guid.cliSessions.workspaceMissing'
  | 'guid.cliSessions.workspaceUnknown'
