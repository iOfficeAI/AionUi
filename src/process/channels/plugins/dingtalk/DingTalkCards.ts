...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'AICore Assistant',
    text: '### AICore Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingHelpCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '',
      '**What is pairing?**',
      'Pairing links your DingTalk account with the local AICore application.',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'AICore Assistant Help',
    text: [
      '### AICore Assistant Help',
      '',
      'A remote assistant to interact with AICore via DingTalk.',
      '',
      '**Common Actions:**',
