...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: 'AICore Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        tag: 'markdown',
        content: [
          'Please pair your account with AICore:',
          '',
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          '1. Open AICore settings',
    ...
    elements: [
      {
        ...
        content: [
          ...
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          'Please approve in AICore settings:',
          '1. Open AICore app',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ AICore Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with AICore via Lark.',
          '',
          '**Common Actions:**',
