 ...
 *   - macOS:   ~/Library/Logs/AICoreDesktop/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\AICoreDesktop\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/AICoreDesktop/logs/YYYY-MM-DD.log
 *
