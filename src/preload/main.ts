...
import type { ElectronBridgeAPI, FeedbackReportSubmitPayload } from '../common/types/electron';
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  submitFeedbackReport: (payload: FeedbackReportSubmitPayload) => ipcRenderer.invoke('feedback:submit-report', payload),
