...
/**
 * The primary agent type for preset assistants, used to decide which
 * conversation kind to create.
 */
export type PresetAgentType = 'gemini' | 'claude' | 'codex' | 'codebuddy' | 'opencode' | 'qwen' | 'kiro' | 'aionrs';

/**
 * Preset agent types that should be routed through ACP instead of using a
 * native Gemini conversation.
 */
...
export type AcpBackend = AgentBackend;
/**
