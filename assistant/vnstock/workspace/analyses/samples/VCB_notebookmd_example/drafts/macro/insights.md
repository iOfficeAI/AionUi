# Macro Regime Investigation: Vietnam

_Generated: 2026-02-21 01:34:44_
...
## Cell 1 — Setup: Gather macro indicators
...
## Cell 2 — Question: What regime are we in?
...
| Rationale  | GDP > 6.5%, Credit > 12%, CPI moderate (< 4.5%) |
    ...
    **Finding**: Vietnam is in EXPANSION phase
    - GDP 7.2% indicates strong economic momentum
    - Credit 14.5% is healthy (not overheating > 18%)
    - Inflation 4.2% is contained (SBV comfort zone)
...
## Cell 3 — Investigation: Are we early, mid, or late cycle?
...
| Key             | Value     |
| --------------- | --------- |
| Expansion Phase | MID-CYCLE |

---

## Cell 4 — Deep dive: What's driving this regime?
...
1. Export growth +15% YoY (strong global demand)

2. Domestic consumption recovering post-pandemic

3. FDI inflows robust ($20bn YTD)

4. Government infrastructure spending accelerating

---

## Cell 5 — Non-obvious sector rotation insight
...
## Cell 6 — Regime transition watch: What could shift regime?
...
## Cell 7 — Bottom line: Actionable macro positioning
