...
with N.cell("Gather sub-agent discoveries"):
    # Read investigation notebooks (in real usage, parse markdown)
...
with N.cell("Triangulate: What emerges when we combine insights?"):
...
with N.cell("Conviction drivers: Why HIGH confidence?"):
...
with N.cell("Investment thesis: The complete picture"):
...
with N.cell("Risk management: What could go wrong?"):
    N.kv({
...
with N.cell("Bottom line: Actionable recommendation"):
    N.kv({
